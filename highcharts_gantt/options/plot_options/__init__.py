...
from highcharts_stock.options.plot_options import PlotOptions as PlotOptionsBase

from highcharts_gantt.options.plot_options.arcdiagram import ArcDiagramOptions
from highcharts_gantt.options.plot_options.area import AreaOptions
from highcharts_gantt.options.plot_options.area import AreaRangeOptions
from highcharts_gantt.options.plot_options.area import AreaSplineOptions
from highcharts_gantt.options.plot_options.area import AreaSplineRangeOptions
from highcharts_gantt.options.plot_options.bar import BarOptions
from highcharts_gantt.options.plot_options.bellcurve import BellCurveOptions
from highcharts_gantt.options.plot_options.boxplot import BoxPlotOptions
from highcharts_gantt.options.plot_options.bubble import BubbleOptions
from highcharts_gantt.options.plot_options.bullet import BulletOptions
from highcharts_gantt.options.plot_options.bar import ColumnOptions
from highcharts_gantt.options.plot_options.bar import ColumnPyramidOptions
from highcharts_gantt.options.plot_options.bar import ColumnRangeOptions
from highcharts_gantt.options.plot_options.bar import CylinderOptions
from highcharts_gantt.options.plot_options.dependencywheel import DependencyWheelOptions
from highcharts_gantt.options.plot_options.dumbbell import DumbbellOptions
from highcharts_gantt.options.plot_options.boxplot import ErrorBarOptions
from highcharts_gantt.options.plot_options.funnel import FunnelOptions
from highcharts_gantt.options.plot_options.funnel import Funnel3DOptions
from highcharts_gantt.options.plot_options.gauge import GaugeOptions
from highcharts_gantt.options.plot_options.heatmap import HeatmapOptions
from highcharts_gantt.options.plot_options.histogram import HistogramOptions
from highcharts_gantt.options.plot_options.item import ItemOptions
from highcharts_gantt.options.plot_options.area import LineOptions
from highcharts_gantt.options.plot_options.dumbbell import LollipopOptions
from highcharts_gantt.options.plot_options.networkgraph import NetworkGraphOptions
...
from highcharts_gantt.options.plot_options.pyramid import Pyramid3DOptions
from highcharts_gantt.options.plot_options.sankey import SankeyOptions
from highcharts_gantt.options.plot_options.scatter import ScatterOptions
from highcharts_gantt.options.plot_options.scatter import Scatter3DOptions
from highcharts_gantt.options.plot_options.series import SeriesOptions
from highcharts_gantt.options.plot_options.gauge import SolidGaugeOptions
from highcharts_gantt.options.plot_options.spline import SplineOptions
from highcharts_gantt.options.plot_options.area import StreamGraphOptions
...
from highcharts_gantt.options.plot_options.vector import VectorOptions
from highcharts_gantt.options.plot_options.venn import VennOptions
from highcharts_gantt.options.plot_options.bar import WaterfallOptions
from highcharts_gantt.options.plot_options.bar import WindBarbOptions
from highcharts_gantt.options.plot_options.wordcloud import WordcloudOptions
from highcharts_gantt.options.plot_options.bar import XRangeOptions

# Highcharts Gantt Plot Options
...
class PlotOptions(PlotOptionsBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.gantt = kwargs.get('gantt', None)

        super().__init__(**kwargs)

    # Highcharts Gantt Properties

    @property
    def gantt(self) -> Optional[GanttOptions]:
        """Configuration for Gantt options.

        :rtype: :class:`GanttOptions` or :obj:`None <python:None>`
        """
        return self._gantt

    @gantt.setter
    @class_sensitive(GanttOptions)
    def gantt(self, value):
        self._gantt = value
