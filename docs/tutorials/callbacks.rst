...
:meth:`.from_python() <highcharts_gantt.utility_classes.javascript_functions.CallbackFunction.from_python>`
...
:meth:`Chart.display() <highcharts_gantt.chart.Chart.display>` or 
:meth:`Chart.to_js_literal() <highcharts_gantt.chart.Chart.to_js_literal>`.
...
:class:`CallbackFunction <highcharts_gantt.utility_classes.javascript_functions.CallbackFunction>` instance:
...
:meth:`CallbackFunction.from_js_literal() <highcharts_gantt.utility_classes.javascript_functions.CallbackFunction.from_js_literal>` class method to create the callback function instance:
