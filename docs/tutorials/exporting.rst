...
:meth:`Chart.options <highcharts_gantt.chart.Chart.options>` settings by configuring the 
:meth:`options.exporting <highcharts_gantt.options.HighchartsOptions.exporting>` 
property. 

In particular, you can apply configuration through an 
:class:`Exporting <highcharts_gantt.options.exporting.Exporting>` instance, which 
...
:meth:`Chart <highcharts_gantt.chart.Chart>`` instance called ``my_chart``:
...
And you can also configure the client-side export to fall back to server-side export should it fail. 
  ...
  .. seealso::
    ...
    * For more details on the extensive options, please see :mod:`highcharts_gantt.options.exporting`
...
:class:`highcharts_gantt.headless_export.ExportServer` with your custom configuration and passing it to the 
:meth:`.download_chart() <highcharts_gantt.chart.Chart.download_chart>` method in the ``server_instance`` 
...
:meth:`.download_chart() <highcharts_gantt.chart.Chart.download_chart>` method also supports 
