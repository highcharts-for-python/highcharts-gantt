...
:class:`Chart <highcharts_gantt.chart.Chart>`, and that chart contains 
options (:class:`HighchartsOptions <highcharts_gantt.options.HighchartsOptions>`). 
...
contains a :meth:`.data <highcharts_gantt.options.series.base.SeriesBase.data>`
...
be represented as:
  ...
  * a :class:`DataPointCollection <highcharts_gantt.options.series.data.collections.DataPointCollection>`
    instance (or a descendent of it) which in turn contains your data values and related
    configuration options
  * an iterable of 
    :class:`DataBase <highcharts_gantt.options.series.data.base.DataBase>`-descended instances,
...
instances and :class:`DataBase <highcharts_gantt.options.series.data.base.DataBase>` instances.

:class:`DataPointCollection <highcharts_gantt.options.series.data.collections.DataPointCollection>` vs :class:`DataBase <highcharts_gantt.options.series.data.base.DataBase>`
=======================================================================================================================================================================================

The :class:`DataPointCollection <highcharts_gantt.options.series.data.collections.DataPointCollection>` 
class stores your individual data points in a combination of three different list-like structures:
  ...
  * as a :class:`numpy.ndarray <numpy:numpy.ndarray>` in the 
    :meth:`.ndarray <highcharts_gantt.options.series.data.collections.DataPointCollections.ndarray>` property
  * as a :class:`list <python:list>` of 
    :class:`DataBase <highcharts_gantt.options.series.data.base.DataBase>` instances in the 
    :meth:`.data_points <highcharts_gantt.options.series.data.collections.DataPointCollections.data_points>`
    property
  * as a :class:`list <python:list>` of primitives (e.g. numbers, strings, etc.) in the 
    :meth:`.array <highcharts_gantt.options.series.data.collections.DataPointCollections.array>`
    property
...
:meth:`.ndarray <highcharts_gantt.options.series.data.collections.DataPointCollections.ndarray>` or
:meth:`.array <highcharts_gantt.options.series.data.collections.DataPointCollections.array>`), from 
...
:class:`.data <highcharts_gantt.options.series.base.SeriesBase.data>` property.
...
.. note::
  ...
  :class:`DataPointCollection <highcharts_gantt.options.series.data.collections.DataPointCollection>` 
  or an iterable of 
  :class:`DataBase <highcharts_gantt.options.series.data.base.DataBase>` instances.

So now that we have ``raw_data`` prepared, we can now load it into a series. There are four ways to do 
this:

  #. By passing it to the :meth:`.data <highcharts_gantt.options.series.base.SeriesBase.data>` property
  ...
  #. By instantiating your *set* of data directly, and passing it to the
     ...
     of our series:
       ...
       .. code-block:: python
         ...
         from highcharts_gantt.options.series.area import LineSeries
         from highcharts_gantt.options.series.data.cartesian import CartesianData
    ...
    #. By instantiating *individual* data points directly, and passing it to
       the :meth:`.data <highcharts_gantt.options.series.base.SeriesBase.data>` property
       of our series:
...
:class:`LineSeries <highcharts_gantt.options.series.area.LineSeries>` instance (or a 
:class:`list <python:list>` of 
:class:`LineSeries <highcharts_gantt.options.series.area.LineSeries>` that contain your data.
...
:meth:`.target <highcharts_gantt.options.series.bullet.BulletSeries>` values on data points
in a :class:`BulletSeries <highcharts_gantt.options.series.bullet.BulletSeries>` instance. We
...
But you can set this property at the data point level in two ways:
  ...
  #. If you data points are represented as a :class:`list <python:list>` of 
     :class:`DataBase <highcharts_gantt.options.series.data.base.DataBase>`-descended objects, then you can
...
:class:`.to_js_literal() <highcharts_gantt.options.series.base.SeriesBase.to_js_literal>` on your series.
