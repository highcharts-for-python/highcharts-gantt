...
from highcharts_gantt.options.defs import MarkerAttributeObject as cls
from highcharts_gantt.options.defs import MarkerASTNode as cls2
from highcharts_gantt.options.defs import MarkerDefinition as cls3
