...
from highcharts_gantt.options.series.candlestick import CandlestickSeries as cls
from highcharts_gantt.options.series.candlestick import HollowCandlestickSeries as cls2
from highcharts_gantt.options.series.candlestick import HeikinAshiSeries as cls3
