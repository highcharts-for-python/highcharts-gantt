...
from highcharts_gantt.options.series.data.range import RangeData as cls
from highcharts_gantt.options.series.data.range import ConnectedRangeData as cls2
