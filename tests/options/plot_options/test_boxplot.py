...
from highcharts_gantt.options.plot_options.boxplot import BoxPlotOptions as cls
from highcharts_gantt.options.plot_options.boxplot import ErrorBarOptions as cls2
