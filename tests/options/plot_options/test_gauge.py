...
from highcharts_gantt.options.plot_options.gauge import GaugeOptions as cls
from highcharts_gantt.options.plot_options.gauge import SolidGaugeOptions as cls2
