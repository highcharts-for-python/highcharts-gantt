...
from highcharts_gantt.options.plot_options.gantt import GanttOptions as cls
...
def test_GanttOptions__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_GanttOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_GanttOptions_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_GanttOptions_to_dict(kwargs, error):
...
def test_GanttOptions_from_js_literal(input_files, filename, as_file, error):
