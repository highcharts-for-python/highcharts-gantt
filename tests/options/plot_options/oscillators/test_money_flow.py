...
from highcharts_gantt.options.plot_options.oscillators.money_flow import MFIOptions as cls
from highcharts_gantt.options.plot_options.oscillators.money_flow import CMFOptions as cls2
